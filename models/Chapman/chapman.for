...
C     ====================================================================
      ...
      real*8, dimension(N), intent(in)  :: chi0
      real*8, dimension(N), intent(out) :: atm8_chap
...
C     Funcs
      ...
      DO i = 1, N, 1
         ...
         if( X(i) .lt. 36 ) then
            atm8_chap(i) = atm8_chap_deq(X(i),chi(i))
         else
            atm8_chap(i) = atm8_chap_asy(X(i),chi(i))
         end if
     ...
     *           * atm8_chap_xK1(X(i)*sin(chi(i)/rad)) - atm8_chap(i)
      ...
      end subroutine atm8_chapman_arr
