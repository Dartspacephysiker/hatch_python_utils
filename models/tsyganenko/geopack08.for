...
c$$$      print*, '-------IN--',X,Y,Z,HXGSW,HYGSW,HZGSW,BXGSW,BYGSW,BZGSW
      IF (EXNAME.eq.'T89D_DP') THEN
            CALL T89D_DP(IOPT,PARMOD,PSI,X,Y,Z,BXGSW,BYGSW,BZGSW)
      ELSE IF (EXNAME.eq.'T89C') THEN
            CALL T89C(IOPT,PARMOD,PSI,X,Y,Z,BXGSW,BYGSW,BZGSW)
      ELSE IF (EXNAME.eq.'T96_01') THEN
      ...
      ENDIF
c$$$      print*, '-------OUT-',X,Y,Z,HXGSW,HYGSW,HZGSW,BXGSW,BYGSW,BZGSW
c$$$      print*, '-------OUT-',X,Y,Z,BXGSW,BYGSW,BZGSW
!         rr = SQRT(X**2 + Y**2 + Z**2)
